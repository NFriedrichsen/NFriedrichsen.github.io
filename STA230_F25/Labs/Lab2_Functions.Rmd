...
```{r, echo=FALSE}
x <- as.numeric(c(1,"a",3, "four", 5, "six", 7, 6)) #base vector. Expected output: 6 8 7
...
paste(c("Vector1: ",x))
paste(c("Vector2: ",y))
paste(c("Expected Output: ",bothNA(x,y)))
