...
We will have in class labs almost every class. In general these will be due the Saturday/Sunday immediately following the class period in which they were released. In order to receive a Satisfactory:
...
We will have approximately weekly homework assignments due on Saturdays/Sundays. In order to receive a Satisfactory:
