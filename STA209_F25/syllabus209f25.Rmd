...
Noyce 2402: 7:00-8:30pm Thursdays
...
**Note:** Previous wording for max cap of 90\% after corrections removed.
...
*Tokens* reflect that life inevitably rears its ugly head in some fashion and ruins your best-laid plans. You begin the course with 2 tokens. Tokens may be used for HW and Lab extensions (1 token = 3 extra days to turn in). Outside of accomodations and the use of these tokens, absolutely **NO** late homework or labs will be accepted. Homeworks or labs due shortly before exams will be exempt from token use as it delays posting of assignment solutions.
