...
If the difference in the response variable (jumping ability) for the groups is very large, such that it would be extremely rare for that difference to be the result of random assignment making very unbalanced groups, we say the difference is **statistically discernible**.
