...
In-class labs contain embedded questions that you and your lab partner(s) will answer together. Some lab questions will be scored for accuracy with feedback given, while others may be scored for effort/completion. Additionally, labs are to be completed collaboratively, and if it becomes clear that you or your partner(s) are using a “divide and conquer” approach to answering lab questions your score on that assignment will be penalized. Labs will be due at 10:00pm the day we do them in class unless otherwise noted, but my goal is for everyone to have them finished before class is over. Your two lowest lab scores will be dropped. 
