---
title: "SST-115 Final Project (Fall 2024)"
...
## Timeline
  ...
  - **Wednesday, Nov 20 at 10pm** -- Email me members of group (2-3). 
    * If you do not have a group and would like to be assigned one, please email  me and let me know
    <br> <br>
  - **Friday, Nov 29 at 10pm** -- Submit a 1-2 paragraph proposal that briefly describes the following:
    ...
    <br> <br>
  - **Friday, Dec 6 at 10pm** -- A PDF documenting an *exploratory analysis* due. This should include
    ...
    <br> <br>
  - **Tues, Dec 17, 9am-12pm** -- Presentations during scheduled final exam time
  
  - **Friday, Dec 20 at 10pm** -- Final report is due
...
### Final Presentation -- EXTRA CREDIT

Presentations will be limited to 10 minutes from each of the groups and delivered during the scheduled final exam time (**Friday Dec 20, 2-5pm**). The presentation should clearly outline 
...
**Note:** How exactly this will factor into your grade for extra credit I am going to figure out over the next few days.
