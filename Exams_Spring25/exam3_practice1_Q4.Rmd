...
**4C**: It is Plot A. Using the plot of Fox and Paramount movies on Page 5, we can see most movies are being overpredicted (=> negative residuals) with a few movies with large underpredictions (=> large positive residuals). This corresponds to plot B.
