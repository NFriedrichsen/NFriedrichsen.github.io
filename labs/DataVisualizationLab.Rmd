...
**Question 1:** Below is a bar chart representing \_. Describe the distribution of the variable. 
...
For this set of questions we are going to use the College data set presented in the last few sets of slides. Read in the dataset for the College data using the following code. (Note: In the graph code chunks I have put the term 'echo=FALSE' in the brackets. This stops RStudio from showing the code in the pdf to save a little bit of space). We will talk more about how to make these graphs on Wednesday.

```{r}
colleges <- read.csv("https://remiller1450.github.io/data/Colleges2019_Complete.csv")
```

**Question 1:** How many observations and variables are there in the dataset? Also show the code you use to answer this question.
