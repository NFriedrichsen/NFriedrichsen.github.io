---
title: "Lab - Introduction to R and R Markdown"
output:
  html_document:
    toc: yes
    toc_float:
...
When you Knit an R Markdown file, it will ask you to first save and name your document. I recommend sticking to a consistent format throughout the semester: something like `lastname_firstname_[lab/hwk]#.Rmd`. For example, I would name this `friedrichsen_nathan_lab1.Rmd`. After you knit, this will also be the name of your pdf.

For this lab, we will be following along with this document which we can begin by downloading the .Rmd file associated with it [here](R_Introduction.Rmd); this is allow us to see side-by-side how the .Rmd file looks compared to the finished output. 
