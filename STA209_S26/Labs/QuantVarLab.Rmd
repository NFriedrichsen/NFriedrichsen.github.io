...
You may use the template .Rmd file [found here](QuantVarLab.Rmd) to fill in your answers.
...
# Part 4 - More on Describing Data & Including Context 
...
### Part 5 - Relationships between Variables (Box Plots)
...
**Part A**: Using the scatterplot above, describe whether there is a relationship/association between Average Faculty Salary and Median 10-year Salary (the median salary of graduates from the college 10 years after receiving their degree) for our sample of colleges. What does this tell us?
