...
There are 20 points, but your score will be calculated out of 18 points and scaled to be out of 5 points. 

Answers to Questions 2b+c, and 3a+b+c will be marked as entirely correct or entirely incorrect (no partial credit). If you have doubts about your answers to these questions, please see me during class or office hours. Confidence intervals shown without work will not receive credit.
...
**Part C:** What does a single dot on a sampling distribution represent?
...
**Part D:** What is the value of the SE for this sample?
...
**Part E:** How many SE's do we need to add and subtract to make a 95\% CI using the t-distribution for this sample?
...
**Part F:** Create a 95\% confidence interval for the population mean. (show work or no credit will be given)
...
**Part H:** Use the confidence interval to justify whether the company seems honest in their advertising claim.