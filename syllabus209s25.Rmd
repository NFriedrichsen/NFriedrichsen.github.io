...
* STA-209-06: Noyce 2402, MWF 2:30-3:50 PM

**Office Hours**:

* Location: Noyce 2207
* Time: 4-5pm Wednesdays and Fridays

**Mentor Information**:

* Nicky (morenoni@grinnell.edu)
* Mentor session: Tuesdays 8-9pm

* Eddie (pikeedwa@grinnell.edu)
* Mentor session: Thursdays 8-9pm

**Gradescope Course numbers**

*Please be cognization of section number.*
...
In-class labs serve as an opportunity to practice content you will see in lectures, and prepare you for homeworks and exams. The labs contain embedded questions that you and your lab partner(s) will answer together. Some lab questions may be scored for accuracy with feedback given, but by and large labs will be scored for effort/completion.

All labs are worth 5 points, and will be due at 10:00pm two days after we are no longer working on it in class, but my goal is for everyone to have them finished before class is over. 
...
There will be 2 midterms and a final exam. Each midterm will focus on a specific set of content, but because course topics are naturally cumulative there may be some questions involving earlier content. The 3 exams will each contribute 20% towards your end-of-semester grade.
...
After the first two exams are graded, I will allow students with scores below X% (TBD) an opportunity for exam corrections. You can earn back half credit for any missed question by submitting a correct answer and explanation of why the original answer was incorrect (up to a maximum exam score of X%). Exam correction answers must be fully correct to receive back half credit for the respective question.
...
Because this course involves some amount of group work, absences impact not only yourself but also your classmates. That said, I understand that missing class is sometimes necessary. I will not take attendance directly, lack of attendance will most likely affect grades for homework, labs, and exams. If you must miss class, it would be polite and civil to let your lab partner know about it ahead of time if possible.

**Late Policy**

Labs and HW assignments may be turned in up to 24 hours late with a 25% deduction applied to the final score. You do not need to inform me of a late assignment, as gradescope will automatically notate it. Any assignment turned in more than 24 hours late will not be accepted. 
